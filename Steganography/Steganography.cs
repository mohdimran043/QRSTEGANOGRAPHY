...
namespace Steganography
{
    public partial class Steganography : Form
    {
        ...
        private void hideButton_Click(object sender, EventArgs e)
        {
            ...
            bmp.Save(@"C:\Users\Mohd\Downloads\sourcecode\Steganography\ENCRYPTED\encrypted.bmp");
        ...
        {
            MessageBox.Show("By: MOHD IMRAN", "AUTHOR");
        }
        ...
        private void generateQRToolStripMenuItem_Click(object sender, EventArgs e)
        {
            GenerateQRCode fs = new GenerateQRCode();
            fs.Show();
        }
    }
}